...
class ExportConfig(BaseModel):
    ...
    attachment_path: str = Field(
        ...
        description=(
            ...
            "  - {attachment_title}: The title of the attachment (sanitized).\n"
            "  - {attachment_file_id}: The file ID of the attachment (GUID, may be empty on Confluence Server).\n"
            "    When empty, automatically uses a combination of attachment_id and title for uniqueness.\n"
            "  - {attachment_extension}: The file extension of the attachment,\n"
            "including the leading dot.\n"
            "\n"
            "Note: The actual filename is generated by the Attachment.filename property,\n"
            "which ensures uniqueness by using file_id when available, or combining\n"
            "attachment_id with title when file_id is empty."
        ),
    ...
    export_format: Literal["markdown", "html"] = Field(
        default="markdown",
        title="Export Format",
        description=(
            "Format for exported pages. Options: markdown, html.\n"
            "  - `markdown`: Convert Confluence HTML to Markdown format (default)\n"
            "  - `html`: Save original Confluence HTML without conversion"
        ),
    )
